...
have Visual Studio 2015 and the Fortify Extension for Visual Studio 2015 installed.

To run this sample, follow these steps:

1. In Visual Studio 2015, open Samples\advanced\c++\VS2015\Sample1\Sample.sln.
