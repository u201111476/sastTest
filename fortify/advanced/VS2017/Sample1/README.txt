...
have Visual Studio 2017 and the Fortify Extension for Visual Studio 2017 installed.

To run this sample, follow these steps:

1. In Visual Studio 2017, open Samples\advanced\c++\VS2017\Sample1\Sample.sln.
